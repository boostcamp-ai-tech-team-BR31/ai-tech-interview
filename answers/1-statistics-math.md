...
여러번 추출한 표본 평균은 **모평균의 ±2 SEM** 범위 안에 **95%** 확률로 들어온다고 말할 수 있습니다.  여기서 **모평균의 ±2 SEM**이 신뢰 구간이 되고 **95%**가 신뢰수준이 되는 것입니다. 하지만 우리는 모평균을 알지 못하기 때문에 신뢰구간을 표본평균을 중심으로 이동시키고, **'모평균이 신뢰구간 안에 들어올 확률이 95%이다'**라고 표현할 수 있습니다.
